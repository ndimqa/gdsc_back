...
type ComplexityRoot struct {
	...
	Query struct {
		Medicine  func(childComplexity int, id string) int
...
type QueryResolver interface {
	...
	Medicine(ctx context.Context, id string) (*model.Medicine, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.medicine":
		...
		return e.complexity.Query.Medicine(childComplexity, args["_id"].(string)), true
...
func (ec *executionContext) _Mutation_createMedicine(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Medicine)
	fc.Result = res
	return ec.marshalOMedicine2ᚖgdscᚗbackᚋgraphᚋmodelᚐMedicine(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_medicine(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Medicine(rctx, fc.Args["_id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewComment(ctx context.Context, obj interface{}) (model.NewComment, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "medicineId":
			...
			it.MedicineID, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputNewMedicine(ctx context.Context, obj interface{}) (model.NewMedicine, error) {
	...
	fieldsInOrder := [...]string{"_id", "name", "description"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputNewPost(ctx context.Context, obj interface{}) (model.NewPost, error) {
	...
	fieldsInOrder := [...]string{"image", "text"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
